...
Sector1:AddToggle("Bring Mon",true,function(value)
...
Sector1:AddToggle("AutoNewWorld",false,function(value)
   _G.AutoNewWorld = value
end)
Sector1:AddToggle("AutoThirdWorld",false,function(value)
   _G.Autothird = value
end)
spawn(function()
   pcall(function()
...
Sector2:AddToggle("AutoEquipMelee",false,function(value)
   _G.AutoMeleekaitun = value
  
end)
Sector2:AddToggle("Fast Attack",_G.Save['Fast Attack'],function(value) 
...
Sector3:AddDropdown("Select Mode Mastery",{'Fruit','Gun'},"Select Mode",false,function(value)
...
Sector4:AddToggle("Skill Z",true,function(t)
  SKILLZ = t
end)
Sector4:AddToggle("Skill X",true,function(t)
  SKILLX = t
end)
Sector4:AddToggle("Skill C",true,function(t)
  SKILLC = t
end)
Sector4:AddToggle("Skill V",true,function(t)
  SKILLV = t
end)
...
Sector6:AddToggle("Auto Rainbow Haki",false,function(t)
...
Sector6:AddToggle("Auto Observations V2",false,function(t)
...
Sector6:AddToggle("Auto Trade Death King",false,function(t)
...
Sector6:AddToggle("Auto SwanGlasses",false,function(t)
  _G.SwanGlasses = t
  if t == false then
     TweenFarm(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame)
  end
...
Sector6:AddToggle("Auto Farm Sea Beasts",false,function(t)
  _G.SEAKING = t
  if t == false then
     TweenFarm(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame)
  end
end)
Sector6:AddToggle("Auto Farm Sea Beasts Hop",false,function(t)
  _G.SEAKINGHOP = t
  if t == false then
     TweenFarm(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame)
  end
...
Sector7:AddToggle("Auto Superhuman",false,function(t)
  _G.Superhuman = t
end)
spawn(function()
  while wait() do
...
Sector7:AddToggle("Auto Dagon Talon",false,function(t)
  _G.DargonTalon = t
  if t then
     local args = {
        [1] = "BlackbeardReward",
...
Sector7:AddToggle("Auto Death Step",false,function(t)
  _G.DeathStep = t
  if t then
     local args = {
        [1] = "BuyBlackLeg"
...
Sector7:AddToggle("Auto Electric Claw",false,function(t)
  _G.Electricclow = t
  if t then
     local args = {
        [1] = "BuyElectro"
...
Sector9:AddToggle("ESP Players",false,function(t)
  ESPPlayer = t
  UpdatePlayerChams()
end)
Sector9:AddToggle("ESP Chest",false,function(t)
  ChestESP = t
  UpdateChestChams() 
end)
...
Sector14:AddToggle("Auto Dungeon",false,function(t)
  _G.AutoRaid = t
end)
Sector14:AddToggle("Kill Aura",false,function(t)
  Killaura = t
end)
Sector14:AddToggle("Auto Next Island",false,function(t)
  NextIsland = t
end)
Sector14:AddToggle("Auto Awakenr", false,function(vu)
   AutoAwakener = vu
end)
spawn(function()
  while wait(.1) do
